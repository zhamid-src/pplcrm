# 🧭 pplCRM Frontend Feature Components Documentation

This document catalogs the domain-specific experience components located under `apps/frontend/src/app/experiences`. These components represent the views, grids, and dashboards corresponding to each domain in pplCRM.
