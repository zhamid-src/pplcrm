...
| Subprocessor list (Azure, Cloudflare, Stripe, Postmark, SendGrid, Twilio, Google Maps, Google/Microsoft sync, Zapier) | integration modules + `.env.production.example`                                     | `privacy-content.ts` (Service providers). Adding/removing a vendor = edit this list, same commit                                                                  |
