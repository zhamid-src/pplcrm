...
const iconsDir = '/Users/zee/Coding/pplcrm/apps/frontend/src/assets/icons';
...
const indexFile = '/Users/zee/Coding/pplcrm/apps/frontend/src/app/uxcommon/components/icons/icons.index.ts';
...
for (const [key, value] of mappedIcons.entries()) {
  ...
  const fullPath = path.resolve('/Users/zee/Coding/pplcrm/apps/frontend/src', value);
