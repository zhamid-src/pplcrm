...
--
-- Name: form_submissions; Type: TABLE; Schema: public; Owner: zeehamid
--
...
ALTER TABLE public.form_submissions OWNER TO zeehamid;

--
-- Name: form_submissions form_submissions_pkey; Type: CONSTRAINT; Schema: public; Owner: zeehamid
--
...
--
-- Name: idx_form_submissions_tenant_form; Type: INDEX; Schema: public; Owner: zeehamid
--

CREATE INDEX idx_form_submissions_tenant_form ON public.form_submissions USING btree (tenant_id, form_id, created_at DESC);

--
-- Name: idx_form_submissions_person; Type: INDEX; Schema: public; Owner: zeehamid
--

CREATE INDEX idx_form_submissions_person ON public.form_submissions USING btree (tenant_id, person_id);

--
-- Name: idx_web_forms_tenant_slug; Type: INDEX; Schema: public; Owner: zeehamid
--
