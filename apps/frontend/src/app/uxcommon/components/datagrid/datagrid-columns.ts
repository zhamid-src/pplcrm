...
export function measureHeaderWidths(table: HTMLTableElement): {
...
export function computePinOffsets(args: {
...
export function computeAutoSizeWidth(table: HTMLTableElement, id: string): number {
  let max = 0;
