  ...
  if (preset === 'welcome') {
    ...
    return [
      ...
      },
      {
        id: 'p4',
        type: 'text',
        content: 'The easiest way to create and send stunning emails for your business.\n\n✨ Create engaging content with ease\n📊 Built-in analytics dashboard\n👥 Collaborative team features\n✅ One-click publishing & sending',
    ...
    return [
      ...
      },
      {
        id: 'n3-t1',
        type: 'text',
        content: 'Here is what is happening around the platform this week. List Sync has been updated to support faster exports for all user accounts.',
      ...
      },
      {
        id: 'n3-t2',
        type: 'text',
        content: 'Household reassignment logic fixes are now live and performing seamlessly under high concurrent load tests.',
        styles: { textAlign: 'left', fontSize: '15px', color: '#374151', paddingTop: '5', paddingBottom: '10' },
      },
      {
        id: 'n3-d2',
      ...
      },
      {
        id: 'n3-t3',
        type: 'text',
        content: 'Security and role access controls have been strengthened across all internal modules and database tables.',
        styles: { textAlign: 'left', fontSize: '15px', color: '#374151', paddingTop: '5', paddingBottom: '10' },
      },
      {
        id: 'n3-d3',
