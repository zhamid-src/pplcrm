        ...
        <div class="grid gap-6">
          ...
          >
            <div class="flex items-center gap-5 flex-1">
              <div class="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
                <pc-icon name="identification" [size]="6"></pc-icon>
              </div>
              <div class="flex-1">
                <h3 class="font-bold text-lg text-base-content mb-1 group-hover:text-primary transition-colors">People</h3>
          ...
          >
            <div class="flex items-center gap-5 flex-1">
              <div class="w-12 h-12 rounded-full bg-secondary/10 flex items-center justify-center text-secondary flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
                <pc-icon name="house-modern" [size]="6"></pc-icon>
              </div>
              <div class="flex-1">
                <h3 class="font-bold text-lg text-base-content mb-1 group-hover:text-secondary transition-colors">Households</h3>
                <p class="text-sm text-base-content/60 font-light">
          ...
          >
            <div class="flex items-center gap-5 flex-1">
              <div class="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center text-accent flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
                <pc-icon name="briefcase" [size]="6"></pc-icon>
              </div>
              <div class="flex-1">
                <h3 class="font-bold text-lg text-base-content mb-1 group-hover:text-accent transition-colors">Companies</h3>
                <p class="text-sm text-base-content/60 font-light">
                      ...
                      <div class="space-y-3">
                        ...
                        <div class="text-xs space-y-1.5 bg-base-100 p-2.5 rounded-lg border border-base-300">
                          ...
                          <div class="flex justify-between text-success gap-2">
                            ...
                            <span class="font-bold truncate text-right flex-1" [title]="getTargetName(group)">{{ getTargetName(group) }}</span>
                          </div>
                          <div class="flex justify-between text-error gap-2">
                            <span class="flex-shrink-0">Remove Duplicate:</span>
                            <span class="font-bold truncate text-right flex-1" [title]="getSourceName(group)">{{ getSourceName(group) }}</span>
                          </div>
                        </div>
                      </div>
                      }
...
export class DuplicateManager implements OnInit {
  ...
  protected getModeIcon(): PcIconNameType {
    switch (this.selectedMode()) {
      case 'people': return 'identification';
      case 'households': return 'house-modern';
      case 'companies': return 'briefcase';
      default: return 'document-duplicate';
    }
  }
  ...
  protected getModeDescription(): string {
    switch (this.selectedMode()) {
      case 'people': return 'Review and merge duplicate people records to keep your database clean.';
      case 'households': return 'Review and merge duplicate household records sharing the exact same address fingerprint.';
      case 'companies': return 'Review and merge duplicate company records sharing the same name.';
      default: return '';
    }
  }
  ...
  protected getMergeDescription(): string {
    switch (this.selectedMode()) {
      case 'people': return 'The duplicate record will be removed, transferring tags, lists, and empty fields to the primary record.';
      case 'households': return 'The duplicate household will be removed, transferring all members (people), tags, lists, and empty fields to the primary household.';
      case 'companies': return 'The duplicate company will be removed, transferring associated contacts and empty fields to the primary company.';
      default: return '';
    }
  }
