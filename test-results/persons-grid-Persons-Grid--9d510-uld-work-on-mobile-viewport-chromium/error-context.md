...
- Name: persons-grid.spec.ts >> Persons Grid >> Performance and Responsiveness >> should work on mobile viewport
- Location: apps/frontend-e2e/src/persons-grid.spec.ts:392:5
