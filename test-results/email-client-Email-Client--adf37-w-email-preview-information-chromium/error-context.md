...
- Name: email-client.spec.ts >> Email Client >> Email List Display >> should show email preview information
- Location: apps/frontend-e2e/src/email-client.spec.ts:259:5
