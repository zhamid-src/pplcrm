...
- Name: persons-grid.spec.ts >> Persons Grid >> Grid Interactions >> should allow column filtering
- Location: apps/frontend-e2e/src/persons-grid.spec.ts:184:5
...
Call log:
  - waiting for locator('th[role="columnheader"]') to be visible
