...
- Name: email-client.spec.ts >> Email Client >> Email Folder Navigation >> should highlight selected folder
- Location: apps/frontend-e2e/src/email-client.spec.ts:238:5
