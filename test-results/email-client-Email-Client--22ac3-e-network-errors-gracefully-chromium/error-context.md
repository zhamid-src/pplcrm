...
- Name: email-client.spec.ts >> Email Client >> Error Handling >> should handle network errors gracefully
- Location: apps/frontend-e2e/src/email-client.spec.ts:367:5
...
Call log:
  - waiting for locator('pc-email-folder-list').getByText('Inbox')
    - waiting for" http://localhost:4200/signin" navigation to finish...
    - navigated to "http://localhost:4200/signin"
