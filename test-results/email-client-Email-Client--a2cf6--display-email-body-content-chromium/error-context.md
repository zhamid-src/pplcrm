...
- Name: email-client.spec.ts >> Email Client >> Email Details Display >> should display email body content
- Location: apps/frontend-e2e/src/email-client.spec.ts:299:5
