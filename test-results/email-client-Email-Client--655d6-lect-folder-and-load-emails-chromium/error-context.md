...
- Name: email-client.spec.ts >> Email Client >> Email Folder Navigation >> should select folder and load emails
- Location: apps/frontend-e2e/src/email-client.spec.ts:227:5
